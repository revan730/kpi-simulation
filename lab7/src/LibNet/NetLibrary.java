...
public static PetriNet CreateNettask2full_1() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	d_P.add(new PetriP("incoming",128));
	d_P.add(new PetriP("P2",0));
	d_P.add(new PetriP("free",0));
	d_P.add(new PetriP("P6",3));
	d_P.add(new PetriP("processed",0));
	d_P.add(new PetriP("P17",0));
	d_P.add(new PetriP("Free R",0));
	d_P.add(new PetriP("P2",1));
	d_P.add(new PetriP("P16",0));
	d_T.add(new PetriT("T1",40.0));
	d_T.get(0).setDistribution("exp", d_T.get(0).getTimeServ());
	d_T.get(0).setParamDeviation(0.0);
	d_T.add(new PetriT("In progress",60.0));
	d_T.get(1).setDistribution("norm", d_T.get(1).getTimeServ());
	d_T.get(1).setParamDeviation(10.0);
	d_T.add(new PetriT("Item is mooving",5.0));
	d_T.add(new PetriT("T14",8.0));
	d_T.add(new PetriT("T16",5.0));
	d_T.add(new PetriT("T12",8.0));
	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
	d_In.add(new ArcIn(d_P.get(2),d_T.get(1),1));
	d_In.add(new ArcIn(d_P.get(3),d_T.get(1),1));
	...
	PetriNet d_Net = new PetriNet("task2full_1",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet CreateNettask2full_2() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	d_P.add(new PetriP("P11",0));
	d_P.add(new PetriP("P12",3));
	d_P.add(new PetriP("Деталь обработана",0));
	d_P.add(new PetriP("Деталь обработана",0));
	d_P.add(new PetriP("P17",0));
	d_P.add(new PetriP("Free R",0));
	d_P.add(new PetriP("P2",1));
	d_P.add(new PetriP("P16",0));
	d_T.add(new PetriT("T11",100.0));
	d_T.get(0).setDistribution("exp", d_T.get(0).getTimeServ());
	d_T.get(0).setParamDeviation(0.0);
	d_T.add(new PetriT("item is mooving",5.0));
	d_T.add(new PetriT("T14",8.0));
	...
	PetriNet d_Net = new PetriNet("task2full_2",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet CreateNettask2full_3() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_Out.add(new ArcOut(d_T.get(2),d_P.get(4),1));
	d_Out.add(new ArcOut(d_T.get(1),d_P.get(1),1));
	PetriNet d_Net = new PetriNet("task2full_3",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet CreateNettask3full_1() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),1));
	d_Out.add(new ArcOut(d_T.get(1),d_P.get(2),1));
	PetriNet d_Net = new PetriNet("task3full_1",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet CreateNettask3full_2() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	d_P.add(new PetriP("P1-conn",0));
	d_P.add(new PetriP("lost profit",0));
	d_P.add(new PetriP("B arrived",1));
	d_P.add(new PetriP("B on its way",0));
	d_P.add(new PetriP("P3",0));
	d_P.add(new PetriP("B arrived",0));
	d_P.add(new PetriP("B on its way",0));
	d_P.add(new PetriP("P6-conn",0));
	d_P.add(new PetriP("A on its way",0));
	d_P.add(new PetriP("A arrived",1));
	d_P.add(new PetriP("A on its way",0));
	d_P.add(new PetriP("A arrived",0));
	d_T.add(new PetriT("leave queue",0.0));
	d_T.add(new PetriT("boarding B",0.0));
	d_T.add(new PetriT("T2",30.0));
	d_T.add(new PetriT("T3",30.0));
	d_T.add(new PetriT("Boarding B",0.0));
	d_T.add(new PetriT("Boarding A",0.0));
	d_T.add(new PetriT("T8",20.0));
	d_T.add(new PetriT("T9",20.0));
	d_T.add(new PetriT("boarding A",0.0));
	d_T.add(new PetriT("leave queue",0.0));
	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),30));
	d_In.add(new ArcIn(d_P.get(0),d_T.get(1),1));
	d_In.add(new ArcIn(d_P.get(3),d_T.get(2),1));
	d_In.add(new ArcIn(d_P.get(2),d_T.get(1),1));
	d_In.add(new ArcIn(d_P.get(6),d_T.get(3),1));
	...
	d_In.add(new ArcIn(d_P.get(0),d_T.get(8),1));
	d_In.add(new ArcIn(d_P.get(7),d_T.get(9),30));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),1));
	d_Out.add(new ArcOut(d_T.get(1),d_P.get(3),1));
	d_Out.add(new ArcOut(d_T.get(2),d_P.get(4),1));
	d_Out.add(new ArcOut(d_T.get(2),d_P.get(5),1));
	...
	PetriNet d_Net = new PetriNet("task3full_2",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
...
public static PetriNet CreateNettask3full_3() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	...
	d_T.add(new PetriT("T5",0.0));
	d_T.add(new PetriT("T6",0.5));
	d_In.add(new ArcIn(d_P.get(2),d_T.get(1),1));
	d_In.add(new ArcIn(d_P.get(1),d_T.get(0),1));
	d_Out.add(new ArcOut(d_T.get(1),d_P.get(2),1));
	d_Out.add(new ArcOut(d_T.get(1),d_P.get(1),1));
	d_Out.add(new ArcOut(d_T.get(0),d_P.get(0),1));
	PetriNet d_Net = new PetriNet("task3full_3",d_P,d_T,d_In,d_Out);
	PetriP.initNext();
	PetriT.initNext();
	ArcIn.initNext();
	ArcOut.initNext();
